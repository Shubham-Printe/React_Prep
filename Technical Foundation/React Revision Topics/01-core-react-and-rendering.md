...
- [x] Reconciliation algorithm: keys, diffing, when re-mount vs update
- [x] Virtual DOM vs actual DOM; costs and benefits in modern React
- [x] JSX compilation and how it maps to `createElement`/runtime
- [x] Component lifecycle in function components via hooks
- [x] StrictMode effects: double-invocation in dev, detection of side-effects
- [x] Controlled vs uncontrolled components (inputs, forms)
- [x] Lifting state up and state colocations principles
- [x] Conditional rendering patterns and short-circuit pitfalls
- [x] Lists: stable keys, index-as-key tradeoffs
